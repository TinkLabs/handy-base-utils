...
public class ResultVO<T> implements Serializable {
    ...
    public static final ResultVO<Object> SUCCESS          = new ResultVO<Object>(BaseErrors.SUCCESS, null);
    ...
    public static <T> ResultVO<T> success(T data) {
        return new ResultVO<T>(BaseErrors.SUCCESS, data);
    }

    public static <T> ResultVO<T> fail(IError error) {
        return new ResultVO<T>(error);
    }

    public static <T> ResultVO<T> fail(IError error, String msg) {
        return new ResultVO<T>(error, msg);
    }
